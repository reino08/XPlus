...
export const extern_ReactNativeAppRegistry: Promise<typeof AppRegistry> = Webpack.getProps(x => x?.Z, "runApplication");
...
export const extern_SidebarButton = Webpack.getString("_renderItemContent", x => x?.ZP);
