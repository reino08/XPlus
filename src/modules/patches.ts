...
import { extern_DraftJSEditor, extern_QuotedPost, extern_ReactNativeAppRegistry, extern_Sidebar, extern_Tweet, extern_TweetUser, extern_UserCard } from "./externs.ts";
...
export const DraftJSEditorPatch = wrap(extern_DraftJSEditor, x => x.prototype, "render");
export const RunApplicationPatch = wrap(extern_ReactNativeAppRegistry, x => x.Z, "runApplication");
